...
public class FiveBallLongAuton extends SequentialCommandGroup {
  /** Creates a new BounceSequence. */
  public FiveBallLongAuton(Drivetrain drivetrain) {
    ...
    Trajectory trajectory1 = TrajectoryCache.get("FiveBallForwardsLong");
